...
class LoaderMod(loader.Module):
    ...
    strings_kk = {
        "repo_config_doc": "Модульләрне күчерер өчен сылтама",
        ...
        "requirements_failed_termux": (
            "<emoji document_id=5407025283456835913>🕶</emoji> <b>Таләпләрне күчерү хата"
            " бар.</b>\n<b>Бу хата Termux-дә алдан башка мөмкин булган библиотекалар"
            " күчерелмәгән өчен туры килә. Бу хата туры килмәгәндә, билдирүне"
            " бермәгәндән күбрәк.</b>"
        ),
        "requirements_installing": (
            "<emoji document_id=5328311576736833844>🚀</emoji> <b>Кертемне төшәрергә"
            " кертемдәр:\n\n{}</b>"
        ),
        "requirements_restart": (
            "<emoji document_id=5875145601682771643>🚀</emoji> <b>Кертемне төшәрергә"
            " кертемдәр урнаштырылды, бу модульны куллану өчен программаны"
            " яңартырга кирәк</b> <code>{}</code>"
        ),
        "all_modules_deleted": (
            "<emoji document_id=5784993237412351403>✅</emoji> <b>Барлык модульләр"
            " юйылды</b>"
        ),
        "undoc": "<emoji document_id=5427052514094619126>🤷‍♀️</emoji> Хисап ителмәгән",
        "ihandler": (
            "\n<emoji document_id=5372981976804366741>🤖</emoji> <code>{}</code> {}"
        ),
        "version_incompatible": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модуль"
            " Hikka версиясы {}+ җитәкләнгән\nЯңартырга</b> <code>.update</code>"
        ),
        "ffmpeg_required": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модуль"
            " FFMPEG җитәкләнгән, алар урнаштырылмаган</b>"
        ),
        "developer": (
            "\n\n<emoji document_id=5875452644599795072>🫶</emoji> <b>Кулланучы:</b> {}"
        ),
        "depends_from": (
            "\n\n<emoji document_id=5431736674147114227>📦</emoji> <b>Төзәтелгән:"
            "</b> \n{}"
        ),
        "by": "үзенчә",
        "module_fs": (
            "💿 <b>Модульне файлга сакларга телисезми? Бу модульне яңарту өчен"
            " яңартырга кирәк</b>"
        ),
        "save": "💿 Саклау",
        "no_save": "🚫 Сакламаячым",
        "save_for_all": "💽 Урнаштырылган һәмдә төзәтелгән модульләрне сакларга",
        "never_save": "🚫 Хәзерге һәмдә бу модульне сакламаячым",
        "will_save_fs": (
            "💽 Барлык модульләрне файлга сакларга телисез, бу модульне яңарту"
            " өчен яңартырга кирәк"
        ),
        "inline_init_failed": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Булышлык"
            " HikkaInline, булышлык инициализация менеджера инлайна</b>\n<i>Соңгы бот"
            " @BotFather өчен сайлаганны өчереп кайтарып карагыз</i>"
        ),
        "_cmd_doc_dlmod": "Йөкләү һәм установка модуль репозитория",
        "_cmd_doc_loadmod": "Йөкләү һәм установка модуль файлы",
        "_cmd_doc_unloadmod": "Йөкләү (өчерү) модуль",
        "_cmd_doc_clearmodules": "Йөкләү установленны модули",
        "_cls_doc": "Установка модули",
        "share_link_doc": "Йөкләү буйынса .dlmod өчен модуль сайлаган",
        "modlink": (
            "\n\n<emoji document_id=6037284117505116849>🌐</emoji> <b>Сылтаны:"
            "</b> <code>{}</code>"
        ),
        "blob_link": (
            "\n\n<emoji document_id=5312383351217201533>⚠️</emoji> <b>Модульнең сылтаны"
            " `blob` белән юкләүне җибәрмәү. `raw` белән юкләү күрсәтелгән.</b>"
        ),
        "raw_link": (
            "\n<emoji document_id=6037284117505116849>🌐</emoji> <b>Сылтаны:"
            "</b> <code>{}</code>"
        ...
        "suggest_subscribe": (
            "\n\n⭐️ <b>Бу модуль"
            " {} төзәткән. Аларның каналына абонемент булдырырга мөмкинчелек бирәгезме?"
        ),
        "subscribe": "💬 Абонемент булдырырга",
        "no_subscribe": "🚫 Абонемент булдырырга теләмәгән",
        "subscribed": "💬 Абонемент булдырылды!",
        "unsubscribed": "🚫 Мен бу каналның абонементы булдырырга теләмәм.",
        "confirm_clearmodules": (
            "⚠️ <b>Сез модульнең барлыгын юкләргә рөхсәт итәргә теләймисез?</b>"
        ),
        "clearmodules": "🗑 Модульнең барлыгын юкләргә",
        "cancel": "🚫 Баш тарту",
        "overwrite_module": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модуль"
            " төзәткән (</b><code>{}</code><b>)</b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Бу хата дегәндә дә бу"
            " кимсән модульне куллануны куллана алмый. Бу модульне үзгәртү мөмкин"
            " булмаска тиеш. Сизне бу хата белән теләфонлау җибәрергә кирәк, яки"
            " support чатына хат җибәрегез</i>"
        ),
        "overwrite_command": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модуль"
            " төзәткән (</b><code>{}</code><b>)</b>\n\n<emoji"
        ...
        "unload_core": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Сезне берген"
            " встроенный модуль</b> <code>{}</code><b></b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Булган эмес, бирге"
            " сакланган модулдарды чончу тамалдырғанда тиешелер. Бу support чаты"
            "нда булганы белдермәңләр</i>"
        ),
        "cannot_unload_lib": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Ты тапкыр"
            " библиотеканы ташлабашмый</b>"
        ),
        "wait_channel_approve": (
            "<emoji document_id=5469741319330996757>💫</emoji> <b>Модуль"
            "</b> <code>{}</code> <b>каналга <a"
            ' href="https://t.me/{}">{}</a> төшәрәп булыр, каналга кереп карый.</b>'
        ),
        "installing": (
            "<emoji document_id=5325792861885570739>🕔</emoji> <b>Модуль"
    ...
    strings_tt = {
        ...
        "avail_header": "🎢 <b>Репозиториядан җибәрелгән официаль модульлар</b>",
        "no_module": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Репозиторияда модуль"
            " юк.</b>"
        ),
        ...
        "provide_module": (
            "<emoji document_id=5312383351217201533>⚠️</emoji> <b>Йүкләү өчен модуль"
            " күрсәтегез</b>"
        ),
        "bad_unicode": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Модульне кодлау"
            " хатасы</b>"
        ),
        "load_failed": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Йүкләү үтәлмәде."
            " Логларны карагыз.</b>"
        ),
        "loaded": (
            "<emoji document_id=5188377234380954537>🌘</emoji> <b>Модуль"
            "</b> <code>{}</code>{} <b>{} исемлектә өстәлде</b>{}{}{}{}{}{}"
        ),
        "no_class": "<b>Чындырмаган булыр, чындырмаган.</b>",
        "unloaded": "{} <b>Модуль {} чындырлы.</b>",
        "not_unloaded": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Модуль чындырлы"
            " түгел.</b>"
        ),
        "requirements_failed": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Модульне чындырмага"
            " тиешле булмады.</b>"
        ),
        "requirements_failed_termux": (
            "<emoji document_id=5407025283456835913>🕶</emoji> <b>Модульне чындырмага"
            " тиешле булмады.</b>\n<b>Бу хата Termux-ка тиешле була мөмкин, чөнки"
            " Termux күп библиотекаларны кулланмый.</b>"
        ),
        "requirements_installing": (
            "<emoji document_id=5328311576736833844>🚀</emoji> <b>Зависимостлар"
            " кушылып бары:\n\n{}</b>"
        ),
        "requirements_restart": (
            "<emoji document_id=5875145601682771643>🚀</emoji> <b>Зависимостлар"
            " кушылды, алай эм керткәндә үзгәртү җитәкләре булыр</b> <code>{}</code>"
        ),
        "all_modules_deleted": (
            "<emoji document_id=5784993237412351403>✅</emoji> <b>Модуләр юйылды</b>"
        ),
        "undoc": "<emoji document_id=5427052514094619126>🤷‍♀️</emoji> Тасвирлама юк",
        "ihandler": (
            "\n<emoji document_id=5372981976804366741>🤖</emoji> <code>{}</code> {}"
        ),
        "version_incompatible": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модул"
            " Hikka версиясе {}+ кәрәклә\nӨсөн кертү</b> <code>.update</code>"
        ),
        "ffmpeg_required": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модул"
            " FFMPEG кәрәклә, алай эм ул юк</b>"
        ),
        "developer": (
            "\n\n<emoji document_id=5875452644599795072>🫶</emoji> <b>Разработчик:"
            "</b> {}"
        ...
        "by": "белән",
        "module_fs": (
            "💿 <b>Сез модульне зеркаләндең, җитәкләрне килтерү өчен һәм үзгәртү"
            " җитәкләре булыр өчен кертү үчен?</b>"
        ),
        "save": "💿 Саклау",
        "no_save": "🚫 Сакламаска",
        ...
        "will_save_fs": (
            "💽 Хәзер эчендә, зеркаләнгән модуллар файлдан кушылган һәм бу өчен кертү"
            " үчен сакланады"
        ),
        "inline_init_failed": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модулга HikkaInline"
            " тиешлелер, а инлайн менеджеринин инициализациясы сәтсіз"
            " аякталды</b>\n<i>Бот администраторыны @BotFather тақтасындағы бар басқа"
            " ботты өшіріп, юзерботты қайта жүктеуіңізді сұраймын</i>"
        ),
        ...
        "_cmd_doc_clearmodules": (
            "Активлык модульнан чыгарып, инсталлердан алып чыгарга"
        ),
        "_cls_doc": "Модульларны чыгарып, инсталлердан алып чыгарга",
        "share_link_doc": (
            "Модульнан чыгарып, инсталлерга кушарганча, файлнинг сылтамасын кушыгыз"
        ),
        "modlink": (
            "\n\n<emoji document_id=6037284117505116849>🌐</emoji> <b>Сылтама:"
            "</b> <code>{}</code>"
        ),
        "blob_link": (
            "\n\n<emoji document_id=5312383351217201533>⚠️</emoji> <b>`blob`"
            " сылтамаларын инсталлерга кушарганча, `raw` сылтамаларын кушыгыз</b>"
        ),
        "raw_link": (
            "\n<emoji document_id=6037284117505116849>🌐</emoji> <b>Сылтама:"
            "</b> <code>{}</code>"
        ...
        "suggest_subscribe": (
            "\n\n⭐️ <b>Бу модуль {} тарафыннан төзилгән. Буларны кушарга караганча,"
            " каналга абонемент аласыз?</b>"
        ),
        ...
        "confirm_clearmodules": (
            "⚠️ <b>Барлык модульларны чыгарып, инсталлердан алып чыгарга хакымсыз"
            " булсынгыз?</b>"
        ),
        "clearmodules": "🗑 Модулларны төшерергә",
        "cancel": "🚫 Баш тарту",
        "overwrite_module": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модуль искече"
            " модульны (</b><code>{}</code><b>) төзәтти</b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Бу хата түгел, берничә"
            " кулланылачак модульларны төзәтү мәсәләсе. Мөмкин булса, бу хатаны support"
            " чатында белдермәгәче.</i>"
        ),
        "overwrite_command": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Бу модуль искече"
            " команданы (</b><code>{}</code><b>) төзәтти</b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Бу хата түгел, берничә"
            " кулланылачак командаларны төзәтү мәсәләсе. Мөмкин булса, бу хатаны"
            " support чатында белдермәгәче.</i>"
        ),
        "unload_core": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Сез искече модульны"
            " төшерә алмыйсыз</b> <code>{}</code><b></b>\n\n<emoji"
            " document_id=5472146462362048818>💡</emoji><i> Бу хата түгел, берничә"
            " кулланылачак модульларны төзәтү мәсәләсе. Мөмкин булса, бу хатаны support"
            " чатында белдермәгәче.</i>"
        ),
        "cannot_unload_lib": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Сезне библиотеканы"
            " чыгармыйсыз</b>"
        ),
        "wait_channel_approve": (
            "<emoji document_id=5469741319330996757>💫</emoji> <b>Модуль"
            "</b> <code>{}</code> <b>каналга кермәгән <a"
            ' href="https://t.me/{}">{}</a>.\n\n<b><emoji'
            ' document_id="5467666648263564704">❓</emoji> Сәбәп:'
            ' {}</b>\n\n<i>Тикшерү <a href="https://t.me/{}">тапкырмасы</a>...</i>'
        ),
        "installing": (
            "<emoji document_id=5325792861885570739>🕔</emoji> <b>Модульны кушыу"
            "</b> <code>{}</code><b>...</b>"
        ),
        "repo_exists": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Репозиторий</b>"
        ...
        "repo_added": (
            "<emoji document_id=5784993237412351403>✅</emoji> <b>Репозиторий</b>"
            " <code>{}</code> <b>өстәлде</b>"
        ),
        "no_repo": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Репозиторийны кертеп"
            " кертеп кушыуыгызны талап итә</b>"
        ),
        "repo_not_exists": (
            "<emoji document_id=5210952531676504517>🚫</emoji> <b>Репозиторий</b>"
            " <code>{}</code> <b>есть</b>"
    ...
    @loader.command(
        ...
        tt_doc="Ресми репозиториянан модульне юкләү",
        alias="dlm",
    )
    ...
    @loader.command(
        ...
        tt_doc="Кушымталган репозиторийны өстәү",
    )
    ...
    @loader.command(
        ...
        tt_doc="Кушымталган репозиторийне юкләү",
    )
