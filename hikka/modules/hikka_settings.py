...
class HikkaSettingsMod(loader.Module):
    ...
    @loader.command(
        ...
        jp_doc="<module> - このチャットで観察者を有効/無効にする",
    ...
    @loader.command(
        ...
        jp_doc="アクティブなNoNickコマンドのリストを表示します",
    ...
    @loader.command(
        ...
        jp_doc="アクティブなNoNickユーザーのリストを表示します",
    ...
    @loader.command(
        ...
        jp_doc="アクティブなNoNickチャットのリストを表示します",
    ...
    @loader.command(
        ...
        jp_doc="Hikka Webインターフェイスにトンネルを開く",
