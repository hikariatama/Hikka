...
class HikkaSecurityMod(loader.Module):
    ...
    @loader.command(
        ...
        jp_doc="[command] - インラインコマンドの権限を設定します",
    ...
    @loader.command(
        ...
        jp_doc="<ユーザー> - ユーザーを `sudo` グループに追加",
    ...
    @loader.command(
        ...
        jp_doc="<ユーザー> - ユーザーを `owner` グループに追加",
    ...
    @loader.command(
        ...
        jp_doc="<ユーザー> - ユーザーを `support` グループに追加",
    ...
    @loader.command(
        ...
        jp_doc="<ユーザー> - ユーザーを `sudo` グループから削除",
    ...
    @loader.command(
        ...
        jp_doc="<ユーザー> - ユーザーを `owner` グループから削除",
    ...
    @loader.command(
        ...
        jp_doc="<ユーザー> - ユーザーを `support` グループから削除",
    ...
    @loader.command(
        ...
        jp_doc='<"user"/"chat"> - 対象セキュリティのルールを削除します',
