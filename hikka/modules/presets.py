...
class Presets(loader.Module):
    ...
    strings_tt = {
        ...
        "_chat_title": "⚙️ Чат модуләре",
        "_chat_desc": (
            "Чат администрирәү өчен модуллар төркеме — фильтрләр, белешмәләр,"
            " мәтин аныңтыру, һ.б."
        ),
        "_service_title": "⚙️ Файдалы модуллар",
        "_service_desc": (
            "Файдалы модуллар — аккаунт урнаштыру, кыска җибәрү, исемлек, һ.б."
        ),
        "_downloaders_title": "📥 Йөкләүчәләр",
        "_downloaders_desc": (
            "Йөкләүчәләр төркеме — YouTube, TikTok, Instagram, Spotify,"
            " VK Музыка һ.б. өчен файллар җибәрү һәм җибәрүләрдән"
            " файлларны алу өчен модуллар."
        ),
        "welcome": (
            "👋 <b>Сәлам! Модулларны каналлардан күчереп алырға урнаштырылған"
            " микдорларны җибәрергә җибәрегезме? Мин бу күрсәтүләрҙе торгын берә"
            " аласыз. Мин бу менюне үҙгәртергә теләсәгез /presets командасын"
            " җибәрегеҙ</b>"
        ),
        "preset": (
            "<b>{}:</b>\nℹ️ <i>{}</i>\n\n⚒ <b>Бу күрсәтү төркеменә"
            " керәк модуллар:</b>\n\n{}"
        ),
        "back": "🔙 Артка",
        "install": "📦 Күрсәтүләрҙе үҙгәртергә",
        "installing": (
            "<emoji document_id=5451732530048802485>⏳</emoji> <b>Төмәл үзлек"
            " </b><code>{}</code><b>...</b>"
        ),
        "installing_module": (
            "<emoji document_id=5451732530048802485>⏳</emoji> <b>Төмәл үзлек"
            "</b> <code>{}</code> <b>({}/{} модуллар)...</b>\n\n<emoji"
            " document_id=5188377234380954537>🌘</emoji> <i>Төмәл үзлек модул {}...</i>"
        ),
        "installed": (
            "<emoji document_id=5436040291507247633>🎉</emoji> <b>Төмәл үзлек"
            "</b> <code>{}</code> <b>төмәлдәндә!</b>"
        ),
